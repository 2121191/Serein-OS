...
serein-user/_kill：     文件格式 elf64-littleriscv
...
main(int argc, char **argv)
{
  ...
  4c:	9f858593          	addi	a1,a1,-1544 # a40 <malloc+0xec>
  50:	4509                	li	a0,2
  52:	00001097          	auipc	ra,0x1
  56:	81c080e7          	jalr	-2020(ra) # 86e <fprintf>
    exit(1);
  5a:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 60e:	4ae50513          	addi	a0,a0,1198 # ab8 <digits>
 612:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6ca:	39ac8c93          	addi	s9,s9,922 # a60 <malloc+0x10c>
 ...
 6d8:	3e4b8b93          	addi	s7,s7,996 # ab8 <digits>
 ...
 7fe:	25e98993          	addi	s3,s3,606 # a58 <malloc+0x104>
        while(*s != 0){
 802:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 8e0:	1f47b783          	ld	a5,500(a5) # ad0 <freep>
 ...
 908:	00e6ea63          	bltu	a3,a4,91c <free+0x4a>
{
 ...
 94a:	18f73523          	sd	a5,394(a4) # ad0 <freep>
}
 94e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 97c:	15853503          	ld	a0,344(a0) # ad0 <freep>
 ...
 9a4:	13090913          	addi	s2,s2,304 # ad0 <freep>
  if(p == (char*)-1)
 9a8:	5afd                	li	s5,-1
 9aa:	a8a5                	j	a22 <malloc+0xce>
    base.s.ptr = freep = prevp = &base;
 9ac:	00000797          	auipc	a5,0x0
 9b0:	12478793          	addi	a5,a5,292 # ad0 <freep>
 9b4:	00000717          	auipc	a4,0x0
 9b8:	12470713          	addi	a4,a4,292 # ad8 <base>
 9bc:	e398                	sd	a4,0(a5)
 9be:	e798                	sd	a4,8(a5)
    base.s.size = 0;
 ...
 9e4:	0ea73823          	sd	a0,240(a4) # ad0 <freep>
      return (void*)(p + 1);
