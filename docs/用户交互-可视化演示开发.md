# Serein V3.0 可视化演示开发工作报告

## 概述
### 翁
给 Serein V3.0 加了 5 个可视化演示程序，用来展示调度器、内存管理、I/O 多路复用、IPC 和网络等内核机制的工作过程。
...
![懒加载终端可视化演示](../img/懒加载终端可视化演示.png)

![CoW终端可视化演示](../img/CoW终端可视化演示.png)
...
![多路复用终端可视化演示](../img/多路复用终端可视化演示.png)
...
```
+================================================================+
|            Serein Socket Monitor (sockviz) v1.2              |
...
| 文件 | 说明 | 代码行数 |
|------|------|---------|
| serein-user/procshow.c | Stride 调度器演示 | ~230 |
| serein-user/stressload.c | CPU 压力工具 | ~50 |
| serein-user/memviz.c | 内存管理演示 | ~300 |
| serein-user/pollwatch.c | poll I/O 演示 | ~300 |
| serein-user/ipcband.c | IPC 综合演示 | ~320 |
| serein-user/sockviz.c | 网络状态监控 | ~350 |
